#ifdef EVAL_CLASS_GESTURES_AllLABELS
...
#define NUMBER_OF_LABELS 26 // number of voice labels
const String words[NUMBER_OF_LABELS] = {"O", "I", "U", "E", "A", "B", "D", "G", "L", "M", "N", "P", "Q", "V", "W", "C", "R", "T", "S", "H", "F", "Z", "Y", "J", "K", "X"}; // words for each label
