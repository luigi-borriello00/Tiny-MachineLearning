#ifdef EVAL_CLASS_GESTURES_10LABELS
...
#define NUMBER_OF_LABELS 10 // number of voice labels
const String words[NUMBER_OF_LABELS] = {"O", "I", "U", "E", "A", "B", "D", "G", "L", "M"}; // words for each label
